    ...
    function myig_gallery(e, f) {
        $.ajax({
            ...
            $.each(c.data, function(i, a) {
                ...
                d += '	<a href="#" data-featherlight="' + c.data[i].images.standard_resolution.url.replace(/\\/, "") + '" class="myig_popup" rel="myig_popup" title="' + b + '">';
            ...
            if (c.pagination.next_max_id != null && c.pagination.next_max_id != undefined) {
                d += '<div class="load_more"><span class="hvr-grow checkout-button button-1 desktop-main-button myig_more" data-next="' + c.pagination.next_max_id + '">MORE</span></div>'
            }
